package com.example.instagram1805

import com.example.instagram1805.adapter.CommentAdapter
import com.example.instagram1805.model.User
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.example.instagram1805.model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.instagram1805.model.Comment::class.java)
